...
public class MoneyShopTab extends JPanel {
	...
	public MoneyShopTab() {
		...
		lblInfo[3].setText("<html><center>Amine's Patreon</center><center>$" + new ShortNumber(CharacterData.Patreon.getPrice().getMoney(), true) + "</center></html>");		
		...
		lblInfo[7].setText("<html><center>Donald Trump</center><center>$" + new ShortNumber(CharacterData.Trump.getPrice().getMoney(), true) + "</center></html>");
		...
		btnBuy[7].addActionListener(event -> Game.buyCharacter(new Trump(), OperationsList.getSelected()));
	}
}
